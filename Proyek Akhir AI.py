...
#______________________________ TAMPILAN awal ___________________________________
    def __init__(self, tampilanAplikasi):
        ...
        tampilanAplikasi.geometry("1366x768")
    ...
    def TampilanHome(self):
        ...
        self.img = Image.open("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Sicepet 1.png")  
        ...
        self.buttonabout = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol About Us.png") 
        ...
        self.buttonadmin = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Masuk.png") 
        ...
        self.buttonExit = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Exit.png") 
        self.Exit = Button(self.tampilanAplikasi,image=self.buttonExit,command=self.Exit,width=50,height=45,borderwidth=0,bg='white',activebackground='white',cursor='hand2').place(x=20, y=15)


    def Tampilan_AboutUs(self):
        self.clear_widgets()

        self.Img_Tampilan_AboutUs = Image.open("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Sicepet 2.png")
        ...
        self.ImgButton_Home = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Homee.png") 
    ...
    def Tampilan_InputUser(self):
        ...
        self.Input_User = Image.open("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Sicepet 3.png")
        ...
        self.df = pd.read_csv("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Rute AI.csv")
        ...
        self.ImgCariRute = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Cari Rute.png") 
        ...
        self.ImgButton_Kembali = PhotoImage(file = r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Kembali.png") 
...
#-------------------------------------------------------------------------------------------------
    ...
    def a_star_search(self, start, goal, heuristik):
        queue = [(0 + heuristik[start], start, [])]  # queue menyimpan (f(n), node, path)
        visited = set()  # Menyimpan node yang sudah dikunjungi
        explored = {}  # Menyimpan biaya terbaik untuk mencapai setiap node

        while queue:
            queue.sort(key=lambda x: x[0])  # Urutkan queue berdasarkan f(n)
            biaya_sekarang, node, jalur = queue.pop(0)  # Ambil node dengan f(n) terkecil

            if node == goal:
                # Jika sampai tujuan, simpan jalan yang dilewati dan kembalikan biaya
                self.jalan_dilewati = [jalan for node, jalan, next_node in jalur]
                return biaya_sekarang, self.jalan_dilewati

            if node in visited:
                continue  # Jika node sudah dikunjungi, lewati

            visited.add(node)  # Tandai node sebagai dikunjungi
            explored[node] = biaya_sekarang  # Simpan biaya terbaik untuk node ini
            ...
            for tetangga, data in self.G[node].items():
                if tetangga not in visited:
                    ...
                    if tetangga not in explored or self.total_biaya < explored[tetangga]:
                        # Hitung estimasi f(n) = g(n) + h(n)
                        total_biaya_estimasi = self.total_biaya + heuristik[tetangga]
                        queue.append((total_biaya_estimasi, tetangga, jalur + [(node, jalan, tetangga)]))
    ...
    def Tampilan_output(self, start_node, kecamatan):
        def submit_goal():
            ...
            if not goal_node:
                showwarning("Peringatan", "Node tujuan harus diisi!")
                return
            
            #------------------------------- Menentukan Rute yang di lewati dengan UCS ------------------------------------
            biaya, jalan_dilewati = self.a_star_search(self.start_node, goal_node)
            ...
            def compare_traffic_conditions(nama_jalan, input_date, input_year):
                ...
                file_2023 = "D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2023.csv"
                file_2024 = "D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2024.csv"
            ...
            if self.input_tahun.get() == '2023':
                datacsv = pd.read_csv('D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2023.csv')
            elif self.input_tahun.get() == '2024':
                datacsv = pd.read_csv('D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2024.csv')
            else:
        ...
        self.Output = Image.open("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Sicepet 4.png")
        ...
        def on_tahun_selected(event):
            ...
            if tahun == "2023":
                self.df = pd.read_csv("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2023.csv")
            elif tahun == "2024":
                self.df = pd.read_csv("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Jalan 2024.csv")
            else:
        ...
        # ------------- Tombol Kembali -------------
        self.ImgButton_Kembali2 = PhotoImage(file=r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Kembali.png")
        Button_Kembali = Button(self.tampilanAplikasi, image=self.ImgButton_Kembali2, command=self.Tampilan_InputUser, width=140, height=40, borderwidth=0, bg='white', activebackground='white', cursor='hand2')
        Button_Kembali.place(x=1068, y=640)

        # ---------- Tombol Submit ------------
        self.ImgButton_Search = PhotoImage(file=r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Search.png")
        ...
        self.ImgButton_clustering = PhotoImage(file=r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Clustering.png")
        ...
        # ----------- Tombol Lihat Graf -------------
        self.ImgButton_LihatGraff = PhotoImage(file=r"D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Tombol Lihat Graf.png")
    ...
    def evaluate_ucs_performance(ucs, start, goal, optimal_path, optimal_cost):
        biaya, jalan_dilewati = ucs.a_star_search(start, goal)
        
        accuracy = 1 if jalan_dilewati == optimal_path else 0
    ...
    def Tampilan_graff(self, kecamatan):
        self.G = nx.Graph()
        data = pd.read_csv("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/Data Set/Data Rute AI.csv")  
    ...
    def Clustering(self, kecamatan):
        ...
        self.Output = Image.open("D:/TUGAS KAMPUS SEMESTER 3/KECERDASAN ARTIFISIAL/[REVISI]Sicepet_Kelompok 6_2023 E/GAMBAR SICEPAT/Sicepet 5.png")
        self.resize6 = self.Output.resize((1280, 720), Image.LANCZOS)
        self.Output_read = ImageTk.PhotoImage(self.resize6)
        self.Label_Output = Label(self.tampilanAplikasi, image=self.Output_read)
        self.Label_Output.place(x=0, y=0, relwidth=1, relheight=1)
